package com.zhangyuan.modules.payment.domain;
...
public class PaymentTransaction {
    ...
    public PaymentTransaction(String paymentNo, Long orderId, String channel, BigDecimal amount, String currency, String requestJson) {
