...
if [ -n "$MENU_ID" ]; then
  ...
  assert_code "A20 更新菜单" "0" "$R"

  R=$(delete "/admin/system/menus/$MENU_ID" "$ADMIN_TOKEN")
  assert_code "A21 删除菜单" "0" "$R"
fi
